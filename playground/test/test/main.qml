...
Window {
    ...
    Rectangle {
        ...
        PropertyAnimation {id: slideOut; target: settingsPanel; properties: "y"; to: 0; duration: 500}
        PropertyAnimation {id: slideIn; target: settingsPanel; properties: "y"; to: -height; duration: 500}
