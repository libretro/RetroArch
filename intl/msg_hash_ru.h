...
MSG_HASH(
   ...
   "ВНИМАНИЕ: быстрое мерцание на некоторых экранах повышает риск появления остаточного изображения. Используйте с осторожностью. // Вставляет кадры чёрного цвета между обычными. Позволяет существенно уменьшить размытие в движении за счёт эмуляции развёртки ЭЛТ и ценой сниж[...]"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "ВНИМАНИЕ: быстрое мерцание на некоторых экранах повышает риск появления остаточного изображения. Используйте с осторожностью. // Имитирует простую бегущую строку развёртки на протяжении нескольких подкадров, разделяя экран по вертикали и отрисовывая каждую часть исходя[...]"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Разрешать ядрам отображать опции в виде категорий в отдельных вложенных меню. Требуется перезапуск ядра."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Обходить возможности сохранений ядер"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_CORE_INFO_SAVESTATE_BYPASS,
   "Позволяет обходить ограничения быстрых сохранений из описаний ядер в целях тестирования связанных функций (упреждение ввода, обратная перемотка и т.д.)."
   )
#ifndef HAVE_DYNAMIC
MSG_HASH(
...
MSG_HASH(
   ...
   "Быстрые сохранения: запись в каталог контента"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Скриншоты: помещать в папки по каталогу контента"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Скриншоты: запись в каталог контента"
   )
MSG_HASH(
