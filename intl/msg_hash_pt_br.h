...
MSG_HASH(MSG_NETPLAY_ENDIAN_DEPENDENT,
	 "Este núcleo não suporta Netplay inter-arquitetura entre esses sistemas"
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_SHARED_CONTEXT,
	 "Dê aos cores renderizados por hardware seu próprio contexto privado. Evita ter que assumir mudanças de estado de hardware entre quadros."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_HARD_SYNC,
	 "Sincronia rígida entre CPU e GPU. Reduz a latência ao custo de performance."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_THREADED,
	 "Melhora a performance ao custo de latência e mais engasgamento de vídeo. Use somente se você não puder obter velocidade total de outra forma."
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_AUDIO_MAX_TIMING_SKEW,
	 "Desvio de Tempo Máximo de Áudio"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_AUTOSAVE_INTERVAL,
	 "Intervalo do Autossalvamento de SaveRAM"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_BLOCK_SRAM_OVERWRITE,
	 "Não sobregravar o SaveRAM ao carregar estado de jogo"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_PLAYLIST_ENTRY_REMOVE,
	 "Permitir a remoção de registros"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_DISK_CYCLE_TRAY_STATUS,
	 "Condição da Bandeja de Alternação de Disco"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_GAME_SPECIFIC_OPTIONS,
	 "Carregar Automaticamente Opções de Núcleo Específicas do Conteúdo"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_INPUT_META_NETPLAY_GAME_WATCH,
	 "Alternar modo jogador/espectador no Netplay"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_NETPLAY_INPUT_LATENCY_FRAMES_MIN,
	 "Quadros da Latência de Entrada"
	)
MSG_HASH(MENU_ENUM_LABEL_VALUE_NETPLAY_INPUT_LATENCY_FRAMES_RANGE,
	 "Faixa de Quadros da Latência de Entrada"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_NO_PLAYLIST_ENTRIES_AVAILABLE,
	 "Não há registros da lista de reprodução disponíveis."
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_REMAP_FILE_SAVE_CORE,
	 "Salvar Arquivo de Remapeamento do Núcleo"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_SORT_SAVEFILES_ENABLE,
	 "Colocar os Arquivos de Jogos Salvos em Pastas"
	)
MSG_HASH(MENU_ENUM_LABEL_VALUE_SORT_SAVESTATES_ENABLE,
	 "Colocar Estados de Jogo em Pastas"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_SYSTEM_BGM_ENABLE,
	 "Habilitar Música de Fundo do Sistema"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_USE_BUILTIN_PLAYER,
	 "Usar o Reprodutor de Mídia Integrado"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_VIDEO_HARD_SYNC,
	 "Sincronização Rígida de GPU"
	)
MSG_HASH(MENU_ENUM_LABEL_VALUE_VIDEO_HARD_SYNC_FRAMES,
	 "Quadros de Sincronização Rígida de GPU"
	)
...
MSG_HASH(MENU_ENUM_LABEL_VALUE_VIDEO_MESSAGE_POS_X,
	 "Posição X da Notificação em Tela"
	)
MSG_HASH(MENU_ENUM_LABEL_VALUE_VIDEO_MESSAGE_POS_Y,
	 "Posição Y da Notificação em Tela"
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_CHEEVOS_HARDCORE_MODE_ENABLE,
	 "Habilitar ou desabilitar estados de jogo, trapaça, voltar atrás, avanço rápido, pausa e câmera-lenta para todos os jogos."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_ONSCREEN_DISPLAY_SETTINGS,
	 "Alterar as configurações de transparência e transparência de teclado, e as configurações de notificação em tela."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_SHOW_HIDDEN_FILES,
	 "Mostrar arquivos/diretórios ocultos no navegador de arquivos."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_HARD_SYNC_FRAMES,
	 "Definir quantos quadros a CPU pode rodar à frente da GPU quando usado o recurso 'Sincronização Rígida de GPU'."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_MAX_SWAPCHAIN_IMAGES,
	 "Informar ao driver de vídeo para usar explicitamente um modo de buffer específico."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_REFRESH_RATE_AUTO,
	 "A taxa de atualização precisamente estimada da tela em Hz."
	)
...
MSG_HASH(MSG_BLOCKING_SRAM_OVERWRITE,
	 "Bloqueando Sobrescrita de SRAM"
	)
...
MSG_HASH(MSG_CONTENT_CRC32S_DIFFER,
	 "O CRC32 dos conteúdos difere. Não é possível usar jogos diferentes."
	)
...
MSG_HASH(MSG_ERROR_LIBRETRO_CORE_REQUIRES_CONTENT,
	 "O núcleo do Libretro requer conteúdo, mas nada foi fornecido."
	)
MSG_HASH(MSG_ERROR_LIBRETRO_CORE_REQUIRES_SPECIAL_CONTENT,
	 "O núcleo do Libretro requer conteúdo especial, mas nenhum foi fornecido."
	)
...
MSG_HASH(MSG_HW_RENDERED_MUST_USE_POSTSHADED_RECORDING,
	 "O núcleo do Libretro é renderizado por hardware. Deve usar a gravação pós-Shader também."
	)
...
MSG_HASH(MSG_REWIND_INIT_FAILED_THREADED_AUDIO,
	 "Esta implementação usa áudio paralelizado. Não é possível voltar atrás."
	)
...
MSG_HASH(MSG_SEVERAL_PATCHES_ARE_EXPLICITLY_DEFINED,
	 "Várias modificações estão explicitamente definidas, ignorando todas..."
	)
MSG_HASH(MSG_SHADER,
	 "Shader"
	)
...
MSG_HASH(MSG_USING_LIBRETRO_DUMMY_CORE_RECORDING_SKIPPED,
	 "Usando o núcleo modelo do libretro. Pulando a gravação."
	)
...
MSG_HASH(MSG_VIEWPORT_SIZE_CALCULATION_FAILED,
	 "Falha no cálculo de tamanho da janela de exibição! Prosseguindo usando dados brutos. Isso provavelmente não funcionará corretamente..."
	)
MSG_HASH(MSG_VIRTUAL_DISK_TRAY,
	 "bandeja de disco virtual."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_AUDIO_LATENCY,
	 "Latência de áudio desejada em milissegundos. Pode não ser honrado se o driver de áudio não puder prover a latência dada."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_AUDIO_MUTE,
	 "Áudio mudo/não-mudo."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_AUDIO_RATE_CONTROL_DELTA,
	 "Ajuda a suavizar as imperfeições na regulagem ao sincronizar áudio e vídeo. Esteja ciente que se desativado, será quase impossível de se obter a sincronização adequada."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_AUDIO_VOLUME,
	 "Volume do áudio (em dB). 0 dB é o volume normal, e nenhum ganho é aplicado."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_AUDIO_WASAPI_FLOAT_FORMAT,
	 "Usar formato de ponto flutuante para o driver WASAPI, se suportado pelo dispositivo de áudio."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_INPUT_AXIS_THRESHOLD,
	 "Até que ponto um eixo deve estar inclinado para resultar em um botão pressionado."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_INPUT_DUTY_CYCLE,
	 "Descreve quão longo deve ser o período de um botão turbo ativado. Os números são descritos como quadros."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_DUMMY_ON_CORE_SHUTDOWN,
	 "Alguns núcleos podem ter um recurso de desligamento. Se habilitado, impedirá que o núcleo feche o RetroArch. Em vez disso, carrega um núcleo modelo."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_REFRESH_RATE,
	 "Taxa de atualização vertical da sua tela. Usado para calcular uma taxa de saída de áudio adequada. OBS: Isso será ignorado se a função 'Vídeo Paralelizado' estiver habilitada."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_AUDIO_ENABLE,
	 "Habilita a saída de áudio."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_AUDIO_MAX_TIMING_SKEW,
	 "Mudança máxima na taxa de saída de áudio. Se aumentado habilita grandes mudanças no sincronismo ao custo de imprecisão de tonalidade de áudio (ex: rodando núcleos PAL em modo NTSC)."
	)
MSG_HASH(MSG_FAILED,
	 "falhou"
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_CONTENT_HISTORY_SIZE,
	 "Limita o número de registros da lista de reprodução para jogos, imagens, música e vídeos."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_INPUT_OVERLAY_HIDE_IN_MENU,
	 "Ocultar a transparência enquanto estiver dentro do menu e mostra novamente ao sair."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_SCALE_INTEGER,
	 "Apenas escalona o vídeo em valores inteiros. O tamanho da base depende da geometria relatada pelo sistema e da proporção de aspecto. Se a função 'Forçar Aspecto' não estiver definida, X / Y serão integralmente escalonados independentemente."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_ROTATION,
	 "Força uma certa rotação da tela. A rotação é adicionada as rotações que o núcleo define."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_FORCE_SRGB_DISABLE,
	 "Desabilita de forma forçada o suporte sRGB FBO. Alguns drivers Intel OpenGL no Windows possuem problemas de vídeo com o suporte sRGB FBO se estiver habilitado. Habilitando isso pode contornar o problema."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_WINDOWED_FULLSCREEN,
	 "Se estiver em tela cheia, prefira usar em modo de janela de tela cheia."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_BLOCK_SRAM_OVERWRITE,
	 "Bloqueia o SaveRAM de ser sobrescrito ao carregar um estado de jogo. Pode causar problemas no jogo."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_FASTFORWARD_RATIO,
	 "A taxa máxima na qual o conteúdo será executado quando usado o avanço-rápido(ex: 5.0x para conteúdos em 60fps = 300 fps max). Se for definido como 0.0x, a taxa de avanço-rápido é ilimitada (sem FPS max)."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_REWIND_ENABLE,
	 "Habilita voltar atrás. Isso irá impactar a performance ao jogar."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_PERFCNT_ENABLE,
	 "Habilita os contadores de performance para o RetroArch (e núcleos)."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_AUTOSAVE_INTERVAL,
	 "Salva automaticamente o SaveRAM não volátil em um intervalo regular. Isso é desativado por padrão a menos que seja definido de outra forma. O intervalo é medido em segundos. Um valor de 0 desativa o salvamento automático."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_INPUT_AUTODETECT_ENABLE,
	 "Habilita a detecção automática de entrada. Isso tentará configurar automaticamente joypads no estilo 'Plug-and-Play'."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_INPUT_DRIVER,
	 "Driver de entrada a ser usado. Dependendo do driver de vídeo, pode forçar um driver de entrada diferente."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_JOYPAD_DRIVER,
	 "Driver de Joypad a ser usado."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_RECORD_DRIVER,
	 "Driver de gravação a ser usado."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_WIFI_DRIVER,
	 "Driver de WiFi a ser usado."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_NAVIGATION_BROWSER_FILTER_SUPPORTED_EXTENSIONS_ENABLE,
	 "Filtra os arquivos a serem exibidos no explorador de arquivos por extensões suportadas."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_AUDIO_DEVICE,
	 "Substitui o dispositivo de áudio padrão usado pelo driver de áudio. Isso depende do driver."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_NETPLAY_PASSWORD,
	 "Senha para conectar ao hospedeiro de Netplay. Usado apenas no modo hospedeiro."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_NETPLAY_STATELESS_MODE,
	 "Define se deve executar o Netplay em modo que não utilize estados de jogo. Se definido como verdadeiro, uma rede muito rápida é necessária, mas voltar atrás não é permitido, então não haverá Netplay instável."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_POINTER_ENABLE,
	 "Habilitar controles de toque no menu."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_SWAP_INTERVAL,
	 "Usa um intervalo de troca personalizado para Vsync. Defina isso para reduzir efetivamente a taxa de atualização do monitor pela metade."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_SORT_SAVEFILES_ENABLE,
	 "Colocar jogos salvos em pastas com o nome do núcleo usado."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_SORT_SAVESTATES_ENABLE,
	 "Colocar estados de jogo em pastas com o nome do núcleo usado."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_LOAD_STATE,
	 "Carregar um estado de jogo salvo do box selecionado atualmente."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_SAVE_CURRENT_CONFIG_OVERRIDE_CORE,
	 "Salva um arquivo de redefinição de configuração que será aplicado a todo o conteúdo carregado com esse núcleo. Terá prioridade sobre a configuração principal."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_SHOW_ADVANCED_SETTINGS,
	 "Mostrar as configurações avançadas para usuários avançados (oculto por padrão)."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_THREADED_DATA_RUNLOOP_ENABLE,
	 "Executar tarefas em linhas de processamento paralelas."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_PLAYLIST_ENTRY_REMOVE,
	 "Permitir que o usuário possa remover registros das coleções."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_SYSTEM_DIRECTORY,
	 "Define o diretório do Sistema. Os núcleos podem consultar este diretório para carregar arquivos  de BIOS, configurações específicas do sistema, etc."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_DYNAMIC_WALLPAPERS_DIRECTORY,
	 "Diretório para armazenar papeis de parede dinamicamente carregados pelo menu dependendo do contexto."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_NETPLAY_INPUT_LATENCY_FRAMES_MIN,
	 "O número de quadros de latência de entrada para o Netplay usar para mascarar a latência da rede. Reduz o jitter e torna o Netplay menos intensivo para a CPU, ao custo de atraso perceptível na entrada."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_NETPLAY_INPUT_LATENCY_FRAMES_RANGE,
	 "O intervalo de quadros de latência de entrada que pode ser usado para mascarar a latência da rede. Reduz o jitter e torna o Netplay menos intensivo para a CPU, ao custo de atraso imprevisível na entrada."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_XMB_SHADOWS_ENABLE,
	 "Habilitar as sombras para todos os ícones. Isso terá um pequeno impacto no desempenho."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_XMB_MENU_COLOR_THEME,
	 "Selecionar um tema de cor degradê de fundo diferente."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_XMB_RIBBON_ENABLE,
	 "Selecionar um efeito de fundo animado. Pode ser que a intensidade de processamento de vídeo seja mais intensa dependendo do efeito. Se a performance for insatisfatória, desligue este efeito ou reverta para um efeito mais simples."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_RGUI_SHOW_START_SCREEN,
	 "Mostrar a tela inicial no menu. Isso é automaticamente definido como falso após o programa iniciar na primeira vez."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_ASSETS_DIRECTORY,
	 "Esta localização é consultada por padrão quando a interface do menu tenta procurar por recursos carregáveis e etc."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_SHADER_APPLY_CHANGES,
	 "As alterações das configurações de Shader tem efeito imediato. Use isso se você alterou a quantidade de iterações de Shader, filtros, escala FBO, etc."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_SHADER_NUM_PASSES,
	 "Aumentar ou diminuir a quantidade de iterações do pipeline de Shader. Você pode adicionar um Shader separado para cada iteração do pipeline e configurar sua escala e filtro."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_SHADER_PARAMETERS,
	 "Modifica o Shader atual diretamente. As alterações não serão salvas no arquivo de predefinição."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_SHADER_PRESET_PARAMETERS,
	 "Modifica a predefinição de Shader atualmente usado no menu."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_CONTENT_SETTINGS,
	 "Acessar rapidamente todas as definições relevantes ao jogo."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_ASPECT_RATIO,
	 "Valor em ponto flutuante da proporção de aspecto de tela (largura / altura), utilizado se Proporção de Tela estiver definido como 'Configuração'."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_VIEWPORT_CUSTOM_X,
	 "Deslocamento personalizado da janela de exibição usado para definir o eixo-X da janela de exibição. Estes serão ignorados se a 'Escala Integral' estiver habilitado. Neste caso ela será centralizada automaticamente."
	)
MSG_HASH(MENU_ENUM_SUBLABEL_VIDEO_VIEWPORT_CUSTOM_Y,
	 "Deslocamento personalizado da janela de exibição usado para definir o eixo-Y da janela de exibição. Estes serão ignorados se a 'Escala Integral' estiver habilitado. Neste caso ela será centralizada automaticamente."
	)
...
MSG_HASH(MENU_ENUM_SUBLABEL_AUDIO_MIXER_MUTE,
	 "Liga/desliga mudo do mixer de áudio."
	)
