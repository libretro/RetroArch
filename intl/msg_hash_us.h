...
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_ADDON,
   "DSU Add-on Mode"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_ACCEL,
   "DSU Accelerometer"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_GYRO,
   "DSU Gyroscope"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_TOUCH,
   "DSU Touch"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_MOUSE,
   "DSU Mouse"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_GAMEPAD,
   "DSU Gamepad"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Configure DSU client for remote inputs."
   )
MSG_HASH(
   MENU_ENUM_LABEL_DSU_CLIENT_PLAYER_SETTINGS,
   "DSU Client Player Settings"
   )
MSG_HASH(
   MENU_ENUM_LABEL_DSU_CLIENT_REMOTE_SETTINGS,
   "DSU Client Remote Settings"
   )
MSG_HASH(
