...
MSG_HASH(
   ...
   MENU_ENUM_LABEL_ANDROID_INPUT_DISCONNECT_WORKAROUND_STR
   )
...
MSG_HASH(
   ...
   MENU_ENUM_LABEL_VIDEO_FRAME_TIME_SAMPLE_GATED_STR
   )
MSG_HASH(
...
MSG_HASH(
   ...
   MENU_ENUM_LABEL_MENU_SHOW_CORE_MANAGER_STEAM_STR
   )
#endif
MSG_HASH(
