...
MSG_HASH(MENU_ENUM_LABEL_INPUT_OVERLAY_AUTO_HIDE,
      "input_overlay_auto_hide")
...
MSG_HASH(MENU_ENUM_LABEL_VIDEO_SMOOTH,
      "video_smooth")
MSG_HASH(MENU_ENUM_LABEL_VIDEO_CTX_SCALING,
      "video_ctx_scaling")
...
MSG_HASH(MENU_ENUM_LABEL_MATERIALUI_SHOW_NAV_BAR,
