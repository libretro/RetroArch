...
MSG_HASH(
   ...
   MENU_ENUM_LABEL_ACCOUNTS_KICK_STR
   )
MSG_HASH(
...
MSG_HASH(
   ...
   MENU_ENUM_LABEL_SAVESTATE_AUTOMATIC_INTERVAL_STR
   )
MSG_HASH(
...
MSG_HASH(
   ...
   MENU_ENUM_LABEL_AUDIO_FASTPATH_S16_STR
   )
MSG_HASH(
...
MSG_HASH(
   ...
   MENU_ENUM_LABEL_FRAME_TIME_COUNTER_AUTO_RESET_STR
   )
MSG_HASH(
