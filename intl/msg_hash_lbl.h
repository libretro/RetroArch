...
MSG_HASH(
   MENU_ENUM_LABEL_CHEEVOS_MENU_SUBMENU,
   MENU_ENUM_LABEL_CHEEVOS_MENU_SUBMENU_STR
   )
MSG_HASH(
...
MSG_HASH(
   MENU_ENUM_LABEL_AUDIO_LATENCY_FLOOR,
   "audio_latency_floor"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   MENU_ENUM_LABEL_CHEEVOS_DESCRIPTION_STR
   )
MSG_HASH(
...
MSG_HASH(
   MENU_ENUM_LABEL_DEFERRED_DROPDOWN_BOX_LIST_CRT_SUPER_RESOLUTION,
   MENU_ENUM_LABEL_DEFERRED_DROPDOWN_BOX_LIST_CRT_SUPER_RESOLUTION_STR
   )
MSG_HASH(
...
MSG_HASH(
   MENU_ENUM_LABEL_DEFERRED_CHEEVOS_ACHIEVEMENT_LIST_SETTINGS_LIST,
   MENU_ENUM_LABEL_DEFERRED_CHEEVOS_ACHIEVEMENT_LIST_SETTINGS_LIST_STR
   )
MSG_HASH(
   MENU_ENUM_LABEL_DEFERRED_ACHIEVEMENTS_SUBMENU_LIST,
   MENU_ENUM_LABEL_DEFERRED_ACHIEVEMENTS_SUBMENU_LIST_STR
   )
MSG_HASH(
...
MSG_HASH(
   ...
   MENU_ENUM_LABEL_INPUT_SDL3_SYSTEM_KEYBOARD_STR
   )
#endif
MSG_HASH(
...
MSG_HASH(
   MENU_ENUM_LABEL_UI_COMPANION_DRIVER,
   MENU_ENUM_LABEL_UI_COMPANION_DRIVER_STR
   )
MSG_HASH(
...
MSG_HASH(
   ...
   MENU_ENUM_LABEL_DISPLAY_INFO_ENTRY_STR
   )
MSG_HASH(
...
MSG_HASH(
   ...
   MENU_ENUM_LABEL_DISPLAY_EDID_ENTRY_STR
   )
MSG_HASH(
