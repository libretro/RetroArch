...
MSG_HASH(MENU_ENUM_LABEL_SHADER_PIPELINE_SNOWFLAKE,
      "shader_pipeline_snowflake")
MSG_HASH(MENU_ENUM_LABEL_SHADER_PIPELINE_FIREWORKS,
      "shader_pipeline_fireworks")
