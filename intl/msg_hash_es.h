...
MSG_HASH(
   ...
   "Muestra un menú de navegación en pantalla con accesos directos. Permite cambiar rápidamente entre categorías. Recomendada para dispositivos que utilicen pantallas táctiles."
   )
MSG_HASH(
