...
} msg_hash_es_blob =
{
   ...
   "Genera \302\253mipmaps\302\273 de las im\303\241genes del men\303\272. Hace que los iconos, mini"
   "aturas y fondos de pantalla se muestren suavizados en resoluciones inferiores a su resoluci\303"
   "\263n nativa a costa de aumentar levemente su consumo de memoria de v\303\255deo.",
   "Permite cubrir el espacio no utilizado en las miniaturas con un fondo plano. Esto garantiza que "
   "todas las im\303\241genes tengan un tama\303\261o uniforme, mejorando la apariencia de los men"
   "\303\272s al ver miniaturas de contenidos y dimensiones base distintos.",
   ...
   "Establece el c\303\263dec con el que se guardar\303\241n los archivos de guardado y los guardado"
   "s r\303\241pidos comprimidos. Zstandard tiene una velocidad de carga muy superior a Deflate y un"
   "a velocidad de guardado algo m\303\241s r\303\241pida, pero sus archivos ser\303\241n m\303\241s"
   " grandes. Los archivos guardados con cualquiera de estos c\303\263decs podr\303\241n volver a le"
   "erse, solo cambiar\303\241n los archivos nuevos.",
   ...
   "eden ejecutarse en otros hilos con los controladores para Vulkna, Direct3D\302\24011, Direct3D"
