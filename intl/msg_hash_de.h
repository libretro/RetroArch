...
MSG_HASH(
   ...
   "OpenGL-Videotreiber. Dieser Treiber ermöglicht die Verwendung von libretro-GL-Cores zusätzlich zu den softwaregerenderten Kernimplementierungen. Die Performance für Software gerenderte und libretro-GL-Core-Implementierungen hängt vom zugrunde liegenden GL-Treiber der Grafikkarte ab."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "SDL 1.2 softwaregerenderter Videotreiber. Die Leistung wird als suboptimal angesehen. Sein Einsatz sollte nur als letzten Ausweg ansehen werden."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Einfacher DRM-Videotreiber. Dies ist ein Low-Level-Videotreiber, der libdrm für Hardwareskalierung mit GPU-Overlays verwendet."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Einen CPU-gestützten Videofilter anwenden. Das kann mit einem hohen Leistungsaufwand verbunden sein. Einige Videofilter funktionieren möglicherweise nur für Cores, die 32-Bit- oder 16-Bit-Farben verwenden. Eine dynamische verknüpfte Videofilterbibliothek auswählen."
   )
MSG_HASH(
   MENU_ENUM_LABEL_HELP_VIDEO_FILTER_BUILTIN,
   "Einen CPU-gestützten Videofilter anwenden. Das kann mit einem hohen Leistungsaufwand verbunden sein. Einige Videofilter funktionieren möglicherweise nur für Cores, die 32-Bit- oder 16-Bit-Farben verwenden. Eine integrierte Videofilterbibliothek auswählen."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Welcher Monitor bevorzugt werden soll.\n0 (Standard) bedeutet, dass kein Monitor bevorzugt wird, bei 1 und höher (wobei 1 der erste Monitor ist) schlägt RetroArch den entsprechenden Monitor vor."
   )
#if defined (WIIU)
MSG_HASH(
...
MSG_HASH(
   ...
   "Legt fest, wie viele Millisekunden nach der VSync-Übersetzung verzögert werden sollen, bevor der Kern ausgeführt wird. Kann die Latenz auf Kosten einer höheren Gefahr von Rucklern verringern. Maximum ist %d."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "\nALSA benötigt ein PCM-Gerät."
   )
MSG_HASH(
   MENU_ENUM_LABEL_HELP_AUDIO_DEVICE_OSS,
   "\nOSS benötigt einen Pfad (z. B. /dev/dsp)."
   )
MSG_HASH(
   MENU_ENUM_LABEL_HELP_AUDIO_DEVICE_JACK,
   "\nJACK benötigt Portnamen (z. B. system:playback1,system:playback_2)."
   )
MSG_HASH(
   MENU_ENUM_LABEL_HELP_AUDIO_DEVICE_RSOUND,
   "\nRSound benötigt eine IP-Adresse zu einem RSound-Server."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Einige Cores benötigen eventuell Firmware- oder BIOS-Dateien.\nWenn diese Option aktiviert ist, lässt RetroArch das Starten des Cores nicht zu, wenn zwingende Firmwareelemente fehlen."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Konfiguration beim Beenden auf die Festplatte speichern. Nützlich für Änderungen, die im Menü vorgenommen wurden. Überschreibt die Konfigurationsdatei, „#include“s und Kommentare werden nicht beibehalten."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Nach dem Ändern der Shader-Einstellungen, wie z. B. Anzahl der Shader-Durchgänge, Filter, FBO-Skala, diese Option verwenden, um Änderungen durchzuführen.\nDiese Shader-Einstellungen zu ändern, ist ein komplexer Vorgang, daher muss genau vorgegangen werden.\nWerden Shader angewendet, werden die Shader-Einstellungen in einer temporären Datei gespeichert (retroarch.slangp/.cgp/.glslp) und geladen. Die Datei bleibt nach dem Beenden von RetroArch erhalten und wird im Shader-Verzeichnis gespeic[...]"
   )
MSG_HASH(
