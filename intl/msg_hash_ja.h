...
MSG_HASH(
   ...
   "先行して実行するフレーム数です. ゲーム内部のラグフレームの数を超えると, ジッターなどのゲームプレイの問題が発生します."
   )
...
MSG_HASH(
   ...
   "[オンラインアップデータ]オプションに, 古いサムネールパッケージをダウンロードするためのエントリを表示します."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "オン/オフ文字列の代わりにアイコンを使用して, '切り替え' メニュー設定エントリを表します."
   )
