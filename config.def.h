...
#define DEFAULT_CLOUD_STORAGE_ENABLE false

#define DEFAULT_CLOUD_STORAGE_GOOGLE_DEFAULT_CREDS false

#define DEFAULT_CLOUD_STORAGE_ONEDRIVE_DEFAULT_CREDS false
