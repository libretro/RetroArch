...
enum runloop_flags
{
   RUNLOOP_FLAG_MAX_FRAMES_SCREENSHOT             = (1U << 0),
   RUNLOOP_FLAG_HAS_SET_CORE                      = (1U << 1),
   RUNLOOP_FLAG_CORE_SET_SHARED_CONTEXT           = (1U << 2),
   RUNLOOP_FLAG_IGNORE_ENVIRONMENT_CB             = (1U << 3),
   RUNLOOP_FLAG_IS_SRAM_LOAD_DISABLED             = (1U << 4),
   RUNLOOP_FLAG_IS_SRAM_SAVE_DISABLED             = (1U << 5),
   RUNLOOP_FLAG_USE_SRAM                          = (1U << 6),
   RUNLOOP_FLAG_PATCH_BLOCKED                     = (1U << 7),
   RUNLOOP_FLAG_REQUEST_SPECIAL_SAVESTATE         = (1U << 8),
   RUNLOOP_FLAG_OVERRIDES_ACTIVE                  = (1U << 9),
   RUNLOOP_FLAG_GAME_OPTIONS_ACTIVE               = (1U << 10),
   RUNLOOP_FLAG_FOLDER_OPTIONS_ACTIVE             = (1U << 11),
   RUNLOOP_FLAG_REMAPS_CORE_ACTIVE                = (1U << 12),
   RUNLOOP_FLAG_REMAPS_GAME_ACTIVE                = (1U << 13),
   RUNLOOP_FLAG_REMAPS_CONTENT_DIR_ACTIVE         = (1U << 14),
   RUNLOOP_FLAG_SHUTDOWN_INITIATED                = (1U << 15),
   RUNLOOP_FLAG_CORE_SHUTDOWN_INITIATED           = (1U << 16),
   RUNLOOP_FLAG_CORE_RUNNING                      = (1U << 17),
   RUNLOOP_FLAG_AUTOSAVE                          = (1U << 18),
   RUNLOOP_FLAG_HAS_VARIABLE_UPDATE               = (1U << 19),
   RUNLOOP_FLAG_INPUT_IS_DIRTY                    = (1U << 20),
   RUNLOOP_FLAG_RUNAHEAD_SAVE_STATE_SIZE_KNOWN    = (1U << 21),
   RUNLOOP_FLAG_RUNAHEAD_AVAILABLE                = (1U << 22),
   RUNLOOP_FLAG_RUNAHEAD_SECONDARY_CORE_AVAILABLE = (1U << 23),
   RUNLOOP_FLAG_RUNAHEAD_FORCE_INPUT_DIRTY        = (1U << 24),
   RUNLOOP_FLAG_SLOWMOTION                        = (1U << 25),
   RUNLOOP_FLAG_FASTMOTION                        = (1U << 26),
   RUNLOOP_FLAG_PAUSED                            = (1U << 27),
   RUNLOOP_FLAG_IDLE                              = (1U << 28),
   RUNLOOP_FLAG_FOCUSED                           = (1U << 29),
   RUNLOOP_FLAG_FORCE_NONBLOCK                    = (1U << 30),
   RUNLOOP_FLAG_IS_INITED                         = (0x80000000)
};
