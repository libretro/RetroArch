...
/**
 * Wrapper for files within the {@link DirectoryFragment}.
 */
final class FileWrapper implements IconAdapterItem, Comparable<FileWrapper>
{
	 ...
	 * @param type      The type of file being wrapped.
	 * @param isEnabled Whether or not the item is selectable.
	 */
