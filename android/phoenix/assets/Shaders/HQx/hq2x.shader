...
void main()
{
    ...
    _TMP15 = rubyTexCoord.xy - _dg1;
    _TMP16 = rubyTexCoord.xy - _dy;
    _TMP17._t1 = vec4(_TMP15.x, _TMP15.y, _TMP16.x, _TMP16.y);
    _TMP13 = rubyTexCoord.xy - _dg2;
    _TMP14 = rubyTexCoord.xy + _dx;
    _TMP17._t2 = vec4(_TMP13.x, _TMP13.y, _TMP14.x, _TMP14.y);
    _TMP11 = rubyTexCoord.xy + _dg1;
    _TMP12 = rubyTexCoord.xy + _dy;
    _TMP17._t3 = vec4(_TMP11.x, _TMP11.y, _TMP12.x, _TMP12.y);
    _TMP9 = rubyTexCoord.xy + _dg2;
    _TMP10 = rubyTexCoord.xy - _dx;
