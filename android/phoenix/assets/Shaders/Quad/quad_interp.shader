...
void main()
{
    ...
    vec3 _res;
    output_dummy _OUT;
    _dx = 1.00000000E+00/(2.00999999E+00*rubyTextureSize.x);
    _dy = 1.00000000E+00/(2.00999999E+00*rubyTextureSize.y);
    ...
    _x0031 = TEX0.x*rubyTextureSize.x;
    _frac_amt_x = fract(_x0031);
    _x0033 = TEX0.y*rubyTextureSize.y;
