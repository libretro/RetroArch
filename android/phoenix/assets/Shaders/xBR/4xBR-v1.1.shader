...
void main()
{
    ...
    _c0071 = TEX0.xy + _g2;
    _TMP11 = texture2D(rubyTexture, _c0071);
    _D = vec3(float(_TMP11.x), float(_TMP11.y), float(_TMP11.z));
    _TMP12 = texture2D(rubyTexture, TEX0.xy);
