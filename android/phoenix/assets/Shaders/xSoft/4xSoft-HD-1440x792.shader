...
void main()
{
    ...
    _TMP16._t1 = vec4(rubyTexCoord.x, rubyTexCoord.y, rubyTexCoord.x, rubyTexCoord.y) + vec4( -6.94274902E-04, -1.26266479E-03, 6.94274902E-04, -1.26266479E-03);
    _TMP16._t2 = vec4(rubyTexCoord.x, rubyTexCoord.y, rubyTexCoord.x, rubyTexCoord.y) + vec4( 6.94274902E-04, 1.26266479E-03, -6.94274902E-04, 1.26266479E-03);
    _TMP16._t3 = vec4(rubyTexCoord.x, rubyTexCoord.y, rubyTexCoord.x, rubyTexCoord.y) + vec4( -3.47137451E-04, -6.31332397E-04, 3.47137451E-04, -6.31332397E-04);
    _TMP16._t4 = vec4(rubyTexCoord.x, rubyTexCoord.y, rubyTexCoord.x, rubyTexCoord.y) + vec4( 3.47137451E-04, 6.31332397E-04, -3.47137451E-04, 6.31332397E-04);
    _TMP16._t5 = vec4(rubyTexCoord.x, rubyTexCoord.y, rubyTexCoord.x, rubyTexCoord.y) + vec4( -6.94274902E-04, 0.00000000E+00, 6.94274902E-04, 0.00000000E+00);
    _TMP16._t6 = vec4(rubyTexCoord.x, rubyTexCoord.y, rubyTexCoord.x, rubyTexCoord.y) + vec4( 0.00000000E+00, -1.26266479E-03, 0.00000000E+00, 1.26266479E-03);
    _position1 = _r0018;
