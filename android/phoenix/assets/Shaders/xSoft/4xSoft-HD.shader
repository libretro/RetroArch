...
void main()
{
    ...
    _TMP16._t1 = vec4(rubyTexCoord.x, rubyTexCoord.y, rubyTexCoord.x, rubyTexCoord.y) + vec4( -1.95312500E-03, -2.23159790E-03, 1.95312500E-03, -2.23159790E-03);
    _TMP16._t2 = vec4(rubyTexCoord.x, rubyTexCoord.y, rubyTexCoord.x, rubyTexCoord.y) + vec4( 1.95312500E-03, 2.23159790E-03, -1.95312500E-03, 2.23159790E-03);
    _TMP16._t3 = vec4(rubyTexCoord.x, rubyTexCoord.y, rubyTexCoord.x, rubyTexCoord.y) + vec4( -9.76562500E-04, -1.11579895E-03, 9.76562500E-04, -1.11579895E-03);
    _TMP16._t4 = vec4(rubyTexCoord.x, rubyTexCoord.y, rubyTexCoord.x, rubyTexCoord.y) + vec4( 9.76562500E-04, 1.11579895E-03, -9.76562500E-04, 1.11579895E-03);
    _TMP16._t5 = vec4(rubyTexCoord.x, rubyTexCoord.y, rubyTexCoord.x, rubyTexCoord.y) + vec4( -1.95312500E-03, 0.00000000E+00, 1.95312500E-03, 0.00000000E+00);
    _TMP16._t6 = vec4(rubyTexCoord.x, rubyTexCoord.y, rubyTexCoord.x, rubyTexCoord.y) + vec4( 0.00000000E+00, -2.23159790E-03, 0.00000000E+00, 2.23159790E-03);
    _position1 = _r0018;
