...
HAVE_ZLIB=auto             # zlib support (uses the built-in DEFLATE codec when disabled)
...
HAVE_LUA=auto              # Lua support (requires C99)
HAVE_ICONV=auto            # Iconv support (encoding conversions)
