...
HAVE_GAMEMODE=yes          # Feral GameMode support (Linux)
C89_GAMEMODE=no
...
HAVE_MODELINE=yes          # Video modeline engine (CRT mode switching); no dependencies
HAVE_CRTSWITCHRES=yes      # One-cycle alias for HAVE_MODELINE
...
HAVE_CORELOCATION=auto     # CoreLocation location driver (Apple, macOS 10.7+ / iOS)
