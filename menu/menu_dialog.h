...
enum menu_dialog_type
{
   ...
   MENU_DIALOG_HELP_WHAT_IS_RETROARCH,
   MENU_DIALOG_HELP_WHAT_IS_A_CORE,
   MENU_DIALOG_HELP_WHAT_IS_THE_LIBRETRO_API,
   MENU_DIALOG_HELP_WHAT_IS_THE_RETROPAD,
   MENU_DIALOG_HELP_LOADING_CONTENT,
   MENU_DIALOG_HELP_SCANNING_CONTENT,
   MENU_DIALOG_HELP_QUICK_MENU,
   MENU_DIALOG_HELP_SHADERS,
   MENU_DIALOG_HELP_SHADER_PRESETS,
