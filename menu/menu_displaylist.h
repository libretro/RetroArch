...
enum menu_displaylist_ctl_state
{
...
#endif
#ifdef HAVE_DSU
   DISPLAYLIST_DSU_CLIENT_SETTINGS_LIST,
   DISPLAYLIST_DSU_CLIENT_PLAYER_SETTINGS_LIST,
   DISPLAYLIST_DSU_CLIENT_REMOTE_SETTINGS_LIST,
#endif
   ...
   DISPLAYLIST_AUXILIARY_SCREEN_STREAMING_LIST,
   DISPLAYLIST_AUX_SCREEN_SETTINGS_LIST,
...
#endif
#ifdef HAVE_DSU
   DISPLAYLIST_OPTIONS_DSU_CLIENT,
#endif
