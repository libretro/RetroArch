...
static enum msg_hash_enums action_ok_dl_to_enum(unsigned lbl)
{
   switch (lbl)
   {
      ...
      case ACTION_OK_DL_CHEEVOS_ACHIEVEMENT_LIST_SETTINGS_LIST:
         return MENU_ENUM_LABEL_DEFERRED_CHEEVOS_ACHIEVEMENT_LIST_SETTINGS_LIST;
...
static const ok_dl_map_t ok_dl_map[] = {
   ...
   { MENU_ENUM_LABEL_CHEEVOS_ACHIEVEMENT_LIST_SETTINGS, ACTION_OK_DL_CHEEVOS_ACHIEVEMENT_LIST_SETTINGS_LIST },
