...
DEFAULT_TITLE_MACRO(action_get_load_dropbox_list,               MENU_ENUM_LABEL_VALUE_LOAD_DROPBOX_LIST)
   ...
   if (cbs->enum_idx != MSG_UNKNOWN)
   {
      switch (cbs->enum_idx)
      {
         ...
         case MENU_ENUM_LABEL_LOAD_DROPBOX_LIST:
            BIND_ACTION_GET_TITLE(cbs, action_get_load_dropbox_list);
            break;
