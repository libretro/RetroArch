...
DEFAULT_TITLE_MACRO(action_get_webhook_settings_list,           MENU_ENUM_LABEL_VALUE_WEBHOOK_SETTINGS)
      ...
      const char *label)
{
   ...
   title_info_list_t info_list[] = {
      ...
      {MENU_ENUM_LABEL_DEFERRED_WEBHOOK_SETTINGS_LIST,                action_get_webhook_settings_list},
