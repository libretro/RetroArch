...
default_sublabel_macro(action_bind_sublabel_menu_show_main_menu,                   MENU_ENUM_SUBLABEL_MENU_SHOW_MAIN_MENU)
   ...
   if (cbs->enum_idx != MSG_UNKNOWN)
   {
      switch (cbs->enum_idx)
      {
         ...
         case MENU_ENUM_LABEL_CONTENT_SHOW_MUSIC:
            ...
            break;
         case MENU_ENUM_LABEL_MENU_SHOW_MAIN_MENU:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_menu_show_main_menu);
            break;
