...
default_sublabel_macro(action_bind_sublabel_onscreen_time_show,            MENU_ENUM_SUBLABEL_ONSCREEN_TIME_SHOW)
   ...
   if (cbs->enum_idx != MSG_UNKNOWN)
   {
      switch (cbs->enum_idx)
      {
         ...
         case MENU_ENUM_LABEL_ONSCREEN_TIME_SHOW:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_onscreen_time_show);
            break;
