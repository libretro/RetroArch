...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_input_overlay_auto_hide,     MENU_ENUM_SUBLABEL_INPUT_OVERLAY_AUTO_HIDE)
   ...
   if (cbs->enum_idx != MSG_UNKNOWN)
   {
      switch (cbs->enum_idx)
      {
         ...
         case MENU_ENUM_LABEL_INPUT_OVERLAY_AUTO_HIDE:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_input_overlay_auto_hide);
            break;
