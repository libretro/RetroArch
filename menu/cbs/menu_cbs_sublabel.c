...
default_sublabel_macro(action_bind_sublabel_backup_core_list,              MENU_ENUM_SUBLABEL_BACKUP_CORE_LIST)
   ...
   if (cbs->enum_idx != MSG_UNKNOWN)
   {
      switch (cbs->enum_idx)
      {
         ...
         case MENU_ENUM_LABEL_BACKUP_CORE_LIST:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_backup_core_list);
            break;
