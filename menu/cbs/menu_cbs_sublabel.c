      ...
      unsigned type, size_t idx)
{
   ...
   static const sublabel_enum_map_t sublabel_map[] = {
      ...
      { MENU_ENUM_LABEL_AUDIO_FASTFORWARD_MODE, MENU_ENUM_SUBLABEL_AUDIO_FASTFORWARD_MODE },
      { MENU_ENUM_LABEL_AUDIO_FASTFORWARD_LOWPASS, MENU_ENUM_SUBLABEL_AUDIO_FASTFORWARD_LOWPASS },
