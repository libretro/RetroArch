      ...
      unsigned type, size_t idx)
{
   ...
   static const sublabel_enum_map_t sublabel_map[] = {
      ...
      { MENU_ENUM_LABEL_VIDEO_THREADED_HW_D3D11, MENU_ENUM_SUBLABEL_VIDEO_THREADED_HW_D3D11 },
      { MENU_ENUM_LABEL_VIDEO_THREADED_HW_OPENGL, MENU_ENUM_SUBLABEL_VIDEO_THREADED_HW_OPENGL },
