...
GENERIC_DEFERRED_PUSH(deferred_push_cheevos_achievement_list_settings_list,DISPLAYLIST_CHEEVOS_ACHIEVEMENT_LIST_SETTINGS_LIST)
      ...
      const char *label)
{
   ...
   static const deferred_info_list_t info_list[] = {
      ...
      {MENU_ENUM_LABEL_DEFERRED_CHEEVOS_ACHIEVEMENT_LIST_SETTINGS_LIST, deferred_push_cheevos_achievement_list_settings_list},
