...
GENERIC_DEFERRED_PUSH(deferred_push_webhook_settings_list,          DISPLAYLIST_WEBHOOK_SETTINGS_LIST)
      ...
      const char *label)
{
   ...
   const deferred_info_list_t info_list[] = {
      ...
      {MENU_ENUM_LABEL_DEFERRED_WEBHOOK_SETTINGS_LIST, deferred_push_webhook_settings_list},
...
/* Thumbnailpack removal */
         ...
         case MENU_ENUM_LABEL_DEFERRED_CHEEVOS_VISIBILITY_SETTINGS_LIST:
            ...
            break;
        case MENU_ENUM_LABEL_DEFERRED_WEBHOOK_SETTINGS_LIST:
            BIND_ACTION_DEFERRED_PUSH(cbs, deferred_push_webhook_settings_list);
            break;
