...
enum
{
   ...
   ACTION_OK_DL_AUXILIARY_SCREEN_STREAMING_LIST,
   ACTION_OK_DL_AUX_SCREEN_SETTINGS_LIST,
...
#endif
#ifdef HAVE_DSU
   ACTION_OK_DL_DSU_CLIENT_SETTINGS_LIST,
   ACTION_OK_DL_DSU_CLIENT_PLAYER_SETTINGS_LIST,
   ACTION_OK_DL_DSU_CLIENT_REMOTE_SETTINGS_LIST,
#endif
