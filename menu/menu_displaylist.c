...
static unsigned menu_displaylist_parse_system_info(menu_displaylist_info_t *info)
{
...

   {
      ...
      menu_features_info_t info_list[54];

      info_list[0].enabled  = _libretrodb_supp;
      info_list[0].msg      = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_LIBRETRODB_SUPPORT;
      info_list[1].enabled  = _overlay_supp;
      info_list[1].msg      = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_OVERLAY_SUPPORT;
      info_list[2].enabled  = _command_supp;
      info_list[2].msg      = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_COMMAND_IFACE_SUPPORT;
      info_list[3].enabled  = _network_command_supp;
      info_list[3].msg      = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_NETWORK_COMMAND_IFACE_SUPPORT;
      info_list[4].enabled  = _network_gamepad_supp;
      info_list[4].msg      = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_NETWORK_REMOTE_SUPPORT;
      info_list[5].enabled  = _cocoa_supp;
      info_list[5].msg      = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_COCOA_SUPPORT;
      info_list[6].enabled  = _rpng_supp;
      info_list[6].msg      = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_RPNG_SUPPORT;
      info_list[7].enabled  = _rjpeg_supp;
      info_list[7].msg      = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_RJPEG_SUPPORT;
      info_list[8].enabled  = _rbmp_supp;
      info_list[8].msg      = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_RBMP_SUPPORT;
      info_list[9].enabled  = _rtga_supp;
      info_list[9].msg      = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_RTGA_SUPPORT;
      info_list[10].enabled = _sdl_supp;
      info_list[10].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_SDL_SUPPORT;
      info_list[11].enabled = _sdl2_supp;
      info_list[11].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_SDL2_SUPPORT;
      info_list[12].enabled = _vulkan_supp;
      info_list[12].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_VULKAN_SUPPORT;
      info_list[13].enabled = _metal_supp;
      info_list[13].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_METAL_SUPPORT;
      info_list[14].enabled = _opengl_supp;
      info_list[14].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_OPENGL_SUPPORT;
      info_list[15].enabled = _opengles_supp;
      info_list[15].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_OPENGLES_SUPPORT;
      info_list[16].enabled = _thread_supp;
      info_list[16].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_THREADING_SUPPORT;
      info_list[17].enabled = _kms_supp;
      info_list[17].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_KMS_SUPPORT;
      info_list[18].enabled = _udev_supp;
      info_list[18].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_UDEV_SUPPORT;
      info_list[19].enabled = _vg_supp;
      info_list[19].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_OPENVG_SUPPORT;
      info_list[20].enabled = _egl_supp;
      info_list[20].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_EGL_SUPPORT;
      info_list[21].enabled = _x11_supp;
      info_list[21].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_X11_SUPPORT;
      info_list[22].enabled = _wayland_supp;
      info_list[22].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_WAYLAND_SUPPORT;
      info_list[23].enabled = _xvideo_supp;
      info_list[23].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_XVIDEO_SUPPORT;
      info_list[24].enabled = _alsa_supp;
      info_list[24].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_ALSA_SUPPORT;
      info_list[25].enabled = _oss_supp;
      info_list[25].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_OSS_SUPPORT;
      info_list[26].enabled = _al_supp;
      info_list[26].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_OPENAL_SUPPORT;
      info_list[27].enabled = _sl_supp;
      info_list[27].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_OPENSL_SUPPORT;
      info_list[28].enabled = _rsound_supp;
      info_list[28].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_RSOUND_SUPPORT;
      info_list[29].enabled = _roar_supp;
      info_list[29].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_ROARAUDIO_SUPPORT;
      info_list[30].enabled = _jack_supp;
      info_list[30].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_JACK_SUPPORT;
      info_list[31].enabled = _pulse_supp;
      info_list[31].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_PULSEAUDIO_SUPPORT;
      info_list[32].enabled = _coreaudio_supp;
      info_list[32].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_COREAUDIO_SUPPORT;
      info_list[33].enabled = _coreaudio3_supp;
      info_list[33].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_COREAUDIO3_SUPPORT;
      info_list[34].enabled = _dsound_supp;
      info_list[34].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_DSOUND_SUPPORT;
      info_list[35].enabled = _wasapi_supp;
      info_list[35].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_WASAPI_SUPPORT;
      info_list[36].enabled = _xaudio_supp;
      info_list[36].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_XAUDIO2_SUPPORT;
      info_list[37].enabled = _zlib_supp;
      info_list[37].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_ZLIB_SUPPORT;
      info_list[38].enabled = _7zip_supp;
      info_list[38].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_7ZIP_SUPPORT;
      info_list[39].enabled = _dylib_supp;
      info_list[39].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_DYLIB_SUPPORT;
      info_list[40].enabled = _dynamic_supp;
      info_list[40].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_DYNAMIC_SUPPORT;
      info_list[41].enabled = _cg_supp;
      info_list[41].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_CG_SUPPORT;
      info_list[42].enabled = _glsl_supp;
      info_list[42].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_GLSL_SUPPORT;
      info_list[43].enabled = _hlsl_supp;
      info_list[43].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_HLSL_SUPPORT;
      info_list[44].enabled = _sdl_image_supp;
      info_list[44].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_SDL_IMAGE_SUPPORT;
      info_list[45].enabled = _ffmpeg_supp;
      info_list[45].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_FFMPEG_SUPPORT;
      info_list[46].enabled = _mpv_supp;
      info_list[46].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_MPV_SUPPORT;
      info_list[47].enabled = _coretext_supp;
      info_list[47].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_CORETEXT_SUPPORT;
      info_list[48].enabled = _freetype_supp;
      info_list[48].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_FREETYPE_SUPPORT;
      info_list[49].enabled = _stbfont_supp;
      info_list[49].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_STB_TRUETYPE_SUPPORT;
      info_list[50].enabled = _netplay_supp;
      info_list[50].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_NETPLAY_SUPPORT;
      info_list[51].enabled = _python_supp;
      info_list[51].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_PYTHON_SUPPORT;
      info_list[52].enabled = _v4l2_supp;
      info_list[52].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_V4L2_SUPPORT;
      info_list[53].enabled = _libusb_supp;
      info_list[53].msg     = MENU_ENUM_LABEL_VALUE_SYSTEM_INFO_LIBUSB_SUPPORT;
