...
enum menu_settings_type
{
   ...
   MENU_SETTING_ACTION_PATCHES,
   MENU_SETTING_ACTION_PATCH_ADD,
   MENU_SETTING_ACTION_PATCH_MOVE_UP,
   MENU_SETTING_ACTION_PATCH_MOVE_DOWN,
   MENU_SETTING_ACTION_PATCH_REMOVE,
   ...
   MENU_SETTINGS_PATCH_BEGIN,
   MENU_SETTINGS_PATCH_END = MENU_SETTINGS_PATCH_BEGIN + (MAX_PATCH_COUNTERS - 1),
   MENU_SETTINGS_PATCH_CANDIDATE_BEGIN,
   MENU_SETTINGS_PATCH_CANDIDATE_END = MENU_SETTINGS_PATCH_CANDIDATE_BEGIN + (MAX_PATCH_COUNTERS - 1),
