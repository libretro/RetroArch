...
enum menu_settings_type
{
   ...
   RARCH_MENU_CTL_PREVENT_POPULATE,
   RARCH_MENU_CTL_FRAME,
   RARCH_MENU_CTL_CHECK_MEMORY_USAGE,
   RARCH_MENU_CTL_SET_PREVENT_POPULATE_FAST,
   RARCH_MENU_CTL_PREVENT_POPULATE_FAST,
   RARCH_MENU_CTL_SET_PREVENT_POPULATE_SLOW,
   MENU_PLAYLISTS_TAB,
