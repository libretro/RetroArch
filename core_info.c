      ...
      if (core_path_basename_a != NULL)
      {
         ...
         if (extension_pos)
         {
            ...
            *((char*)extension_pos) = '\0';
            const char* underscore_pos = strrchr(core_path_basename_a, '_');
            /* restore extension */
            *((char*)extension_pos) = '.';
            ...
            if (underscore_pos)
            {
               ...
               if (string_starts_with_size(core_path_basename_a, core_path_basename_b, core_base_file_id_length))
                  return true;
            }
         }
      }
