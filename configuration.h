...
typedef struct settings
{
   ...
   struct
   {
      ...
      char cheevos_webhook_url[512];
      char cheevos_webhook_code_url[512];
      char cheevos_webhook_token_url[512];
      char cheevos_webhook_usercode[128];
      char cheevos_webhook_accesstoken[1024];
      char cheevos_webhook_refreshtoken[1024];
      char cheevos_webhook_expiresin[64];
