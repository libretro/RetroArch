...
#define INPUT_CONFIG_MASS_BIND_ORDER_TEN(ten) \
    ...
    INPUT_CONFIG_MASS_BIND_ORDER(INPUT_CONFIG_MASS_BIND_ORDER_PASTE(ten, 2)), \
    INPUT_CONFIG_MASS_BIND_ORDER(INPUT_CONFIG_MASS_BIND_ORDER_PASTE(ten, 3)), \
    INPUT_CONFIG_MASS_BIND_ORDER(INPUT_CONFIG_MASS_BIND_ORDER_PASTE(ten, 4)), \
    INPUT_CONFIG_MASS_BIND_ORDER(INPUT_CONFIG_MASS_BIND_ORDER_PASTE(ten, 5)), \
    INPUT_CONFIG_MASS_BIND_ORDER(INPUT_CONFIG_MASS_BIND_ORDER_PASTE(ten, 6)), \
