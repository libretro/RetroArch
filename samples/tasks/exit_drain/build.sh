#!/bin/sh
# Builds the exit-path task-drain harness.
#
...
# the frontend is.
sed 's#-o obj-unix/release/retroarch\.o#-Dmain=rarch_harness_unused_main -o samples/tasks/exit_drain/retroarch_nomain.o#' \
   "$cc_line" | sh

sed -e 's#-o obj-unix/release/retroarch\.o#-o samples/tasks/exit_drain/harness_main.o#' \
    -e 's# retroarch\.c# samples/tasks/exit_drain/exit_drain_test.c#' \
   "$cc_line" | sh
...
sed -e 's#obj-unix/release/retroarch\.o#samples/tasks/exit_drain/retroarch_nomain.o samples/tasks/exit_drain/harness_main.o#' \
    -e 's#-o retroarch #-o samples/tasks/exit_drain/exit_drain_test #' \
   "$ld_line" | sh

echo "built samples/tasks/exit_drain/exit_drain_test"
