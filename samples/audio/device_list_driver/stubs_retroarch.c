...
/* The real one walks the driver tables in retroarch.c; this harness
 * includes audio_driver.c, so the audio table is visible here and the
 * lookup is done against it, which is all this harness asks of it. */
