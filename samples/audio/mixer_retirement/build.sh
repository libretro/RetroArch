#!/bin/sh
# Builds the mixer add-stream init-window harness.
#
...
# the frontend is.
sed 's#-o obj-unix/release/retroarch\.o#-Dmain=rarch_harness_unused_main -o samples/audio/mixer_retirement/retroarch_nomain.o#' \
   "$cc_line" | sh

sed -e 's#-o obj-unix/release/retroarch\.o#-o samples/audio/mixer_retirement/harness_main.o#' \
    -e 's# retroarch\.c# samples/audio/mixer_retirement/mixer_retirement_test.c#' \
   "$cc_line" | sh
...
sed -e 's#obj-unix/release/retroarch\.o#samples/audio/mixer_retirement/retroarch_nomain.o samples/audio/mixer_retirement/harness_main.o#' \
    -e 's#-o retroarch #-o samples/audio/mixer_retirement/mixer_retirement_test #' \
   "$ld_line" | sh

echo "built samples/audio/mixer_retirement/mixer_retirement_test"
