...
# the frontend is.
sed 's#-o obj-unix/release/retroarch\.o#-Dmain=rarch_harness_unused_main -o samples/menu/playlist_nav/retroarch_nomain.o#' \
   "$cc_line" | sh

sed -e 's#-o obj-unix/release/retroarch\.o#-o samples/menu/playlist_nav/harness_main.o#' \
    -e 's# retroarch\.c# samples/menu/playlist_nav/menu_playlist_nav_test.c#' \
   "$cc_line" | sh
...
sed -e 's#obj-unix/release/retroarch\.o#samples/menu/playlist_nav/retroarch_nomain.o samples/menu/playlist_nav/harness_main.o#' \
    -e 's#-o retroarch #-o samples/menu/playlist_nav/menu_playlist_nav_test #' \
   "$ld_line" | sh

echo "built samples/menu/playlist_nav/menu_playlist_nav_test"
