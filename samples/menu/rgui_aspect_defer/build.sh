#!/bin/sh
# Builds the rgui deferred aspect-config write harness.
#
...
# the frontend is.
sed 's#-o obj-unix/release/retroarch\.o#-Dmain=rarch_harness_unused_main -o samples/menu/rgui_aspect_defer/retroarch_nomain.o#' \
   "$cc_line" | sh

sed -e 's#-o obj-unix/release/retroarch\.o#-o samples/menu/rgui_aspect_defer/harness_main.o#' \
    -e 's# retroarch\.c# samples/menu/rgui_aspect_defer/rgui_aspect_defer_test.c#' \
   "$cc_line" | sh
...
sed -e 's#obj-unix/release/retroarch\.o#samples/menu/rgui_aspect_defer/retroarch_nomain.o samples/menu/rgui_aspect_defer/harness_main.o#' \
    -e 's#-o retroarch #-o samples/menu/rgui_aspect_defer/rgui_aspect_defer_test #' \
   "$ld_line" | sh

echo "built samples/menu/rgui_aspect_defer/rgui_aspect_defer_test"
