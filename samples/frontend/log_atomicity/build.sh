#!/bin/sh
# Builds the concurrent log-line integrity harness.
#
...
# the frontend is.
sed 's#-o obj-unix/release/retroarch\.o#-Dmain=rarch_harness_unused_main -o samples/frontend/log_atomicity/retroarch_nomain.o#' \
   "$cc_line" | sh

sed -e 's#-o obj-unix/release/retroarch\.o#-o samples/frontend/log_atomicity/harness_main.o#' \
    -e 's# retroarch\.c# samples/frontend/log_atomicity/log_atomicity_test.c#' \
   "$cc_line" | sh
...
sed -e 's#obj-unix/release/retroarch\.o#samples/frontend/log_atomicity/retroarch_nomain.o samples/frontend/log_atomicity/harness_main.o#' \
    -e 's#-o retroarch #-o samples/frontend/log_atomicity/log_atomicity_test #' \
   "$ld_line" | sh

echo "built samples/frontend/log_atomicity/log_atomicity_test"
