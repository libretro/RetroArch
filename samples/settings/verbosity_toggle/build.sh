#!/bin/sh
# Builds the menu verbosity-toggle transition harness.
#
...
# the frontend is.
sed 's#-o obj-unix/release/retroarch\.o#-Dmain=rarch_harness_unused_main -o samples/settings/verbosity_toggle/retroarch_nomain.o#' \
   "$cc_line" | sh

sed -e 's#-o obj-unix/release/retroarch\.o#-o samples/settings/verbosity_toggle/harness_main.o#' \
    -e 's# retroarch\.c# samples/settings/verbosity_toggle/verbosity_toggle_test.c#' \
   "$cc_line" | sh
...
sed -e 's#obj-unix/release/retroarch\.o#samples/settings/verbosity_toggle/retroarch_nomain.o samples/settings/verbosity_toggle/harness_main.o#' \
    -e 's#-o retroarch #-o samples/settings/verbosity_toggle/verbosity_toggle_test #' \
   "$ld_line" | sh

echo "built samples/settings/verbosity_toggle/verbosity_toggle_test"
