...
void main()
{
    ...
    _TMP16._t1 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( -1.30176544E-03, -2.08282471E-03, 1.30176544E-03, -2.08282471E-03);
    _TMP16._t2 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( 1.30176544E-03, 2.08282471E-03, -1.30176544E-03, 2.08282471E-03);
    _TMP16._t3 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( -6.50882721E-04, -1.04141235E-03, 6.50882721E-04, -1.04141235E-03);
    _TMP16._t4 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( 6.50882721E-04, 1.04141235E-03, -6.50882721E-04, 1.04141235E-03);
    _TMP16._t5 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( -1.30176544E-03, 0.00000000E+00, 1.30176544E-03, 0.00000000E+00);
    _TMP16._t6 = vec4(TexCoord.x, TexCoord.y, TexCoord.x, TexCoord.y) + vec4( 0.00000000E+00, -2.08282471E-03, 0.00000000E+00, 2.08282471E-03);
