...
void main()
{
    ...
    _TMP13._frame_count = float(FrameCount)/2.00000000E+01;
    _a0026 = 5.00000000E-01*_TMP13._frame_count;
    _TMP1 = sin(_a0026);
...
void main()
{
    ...
    vec4 _maximum;
    vec4 _diff;
    _tex_mid = texture2D(Texture, TEX1.xy);
    _tex0 = texture2D(Texture, TEX2.xy);
    _tex60 = texture2D(Texture, TEX3.xy);
    _tex120 = texture2D(Texture, TEX4.xy);
    _tex180 = texture2D(Texture, TEX5.xy);
    _tex240 = texture2D(Texture, TEX6.xy);
    _tex300 = texture2D(Texture, TEX7.xy);
