...
void main()
{
    ...
    _TMP0 = texture2D(Texture, _c0036);
    ...
    _TMP4 = texture2D(Texture, _c0044);
    _C3 = vec3(float(_TMP4.x), float(_TMP4.y), float(_TMP4.z));
    _TMP5 = texture2D(Texture, _pC4);
