...
LC=libretro-common
INC="-I. -I$LC/include"
DEFS="-DRARCH_INTERNAL -DHAVE_THREADS -DHAVE_RTGA"
...
$CC -std=c89 -ansi -pedantic -Werror=pedantic -Wno-long-long -Wall -Wextra \
   -Wno-unused-parameter -Werror=declaration-after-statement \
   $INC -DRARCH_INTERNAL -c ui/companion/companion_thumbs.c -o "$OUT/c89.o"

$CC -std=gnu99 -O1 -g $SAN -Wall -Wextra -Wno-unused-parameter \
   $INC $DEFS $SRCS -o "$OUT/companion_thumbs_test" -lpthread -lm
