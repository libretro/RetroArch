...
typedef bool (*custom_font_command_method_t)(const font_renderer_t **font_driver,
      void **font_handle, void *video_data, const font_t *font_data);
...
bool video_thread_font_init(const font_renderer_t **font_driver,
      void **font_handle,
      void *data,
