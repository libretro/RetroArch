...
/**
 * Raises the calling thread through the first backend that grants it.
 * Returns at once. On PENDING, *pending_via (if given) is set to the
 * ident of the backend now working on it.
 */
