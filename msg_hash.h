...
enum msg_hash_enums
{
   ...
   MENU_ENUM_LABEL_INPUT_SENSOR_MAPPING,
   MENU_ENUM_LABEL_INPUT_SENSOR_MAPPING_LAST = MENU_ENUM_LABEL_INPUT_SENSOR_MAPPING + RETROPAD_RETRO_SENSOR_LAST,
   MENU_ENUM_LABEL_INPUT_SENSOR_AUTO_DISPLAY,
   MENU_ENUM_LABEL_INPUT_SENSOR_AUTO_DISPLAY_LAST = MENU_ENUM_LABEL_INPUT_SENSOR_MAPPING + RETROPAD_RETRO_SENSOR_LAST,
