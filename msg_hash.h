...
enum msg_hash_enums
{
   ...
   MENU_LABEL(CHEEVOS_WEBHOOK_SETTINGS),
   MENU_LABEL(CHEEVOS_WEBHOOK_URL),
   MENU_LABEL(CHEEVOS_WEBHOOK_CODE_URL),
   MENU_LABEL(CHEEVOS_WEBHOOK_TOKEN_URL),
   MENU_LABEL(CHEEVOS_WEBHOOK_START_ASSOCIATION),
   MENU_LABEL(CHEEVOS_WEBHOOK_ABORT_ASSOCIATION),
   MENU_LABEL(CHEEVOS_WEBHOOK_CODE),
