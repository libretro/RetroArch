...
enum msg_hash_enums
{
   ...
   MENU_ENUM_LABEL_VALUE_TIMEDATE_STYLE_YMD_HMS_AMPM,
   MENU_ENUM_LABEL_VALUE_TIMEDATE_STYLE_YMD_HM_AMPM,
   MENU_ENUM_LABEL_VALUE_TIMEDATE_STYLE_MDYYYY_HMS_AMPM,
   MENU_ENUM_LABEL_VALUE_TIMEDATE_STYLE_MDYYYY_HM_AMPM,
   MENU_ENUM_LABEL_VALUE_TIMEDATE_STYLE_MD_HM_AMPM,
   MENU_ENUM_LABEL_VALUE_TIMEDATE_STYLE_DDMMYYYY_HMS_AMPM,
   MENU_ENUM_LABEL_VALUE_TIMEDATE_STYLE_DDMMYYYY_HM_AMPM,
   MENU_ENUM_LABEL_VALUE_TIMEDATE_STYLE_DDMM_HM_AMPM,
   MENU_ENUM_LABEL_VALUE_TIMEDATE_STYLE_HMS_AMPM,
   MENU_ENUM_LABEL_VALUE_TIMEDATE_STYLE_HM_AMPM,
