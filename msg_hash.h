...
enum msg_hash_enums
{
   ...
   MENU_LABEL(HELP_WHAT_IS_RETROARCH),
   MENU_LABEL(HELP_WHAT_IS_A_CORE),
   MENU_LABEL(HELP_WHAT_IS_THE_LIBRETRO_API),
   MENU_LABEL(HELP_WHAT_IS_THE_RETROPAD),
   MENU_LABEL(HELP_LOADING_CONTENT),
   MENU_LABEL(HELP_SCANNING_CONTENT),
   MENU_LABEL(HELP_QUICK_MENU),
   MENU_LABEL(HELP_SHADERS),
   MENU_LABEL(HELP_SHADER_PRESETS),
   ...
   MENU_ENUM_LABEL_VALUE_WHAT_IS_RETROARCH_DESC,
   MENU_ENUM_LABEL_VALUE_WHAT_IS_A_CORE_DESC,
   MENU_ENUM_LABEL_VALUE_WHAT_IS_THE_LIBRETRO_API_DESC,
   MENU_ENUM_LABEL_VALUE_WHAT_IS_THE_RETROPAD_DESC,
   MENU_ENUM_LABEL_VALUE_LOADING_CONTENT_DESC,
   MENU_ENUM_LABEL_VALUE_SCANNING_CONTENT_DESC,
   MENU_ENUM_LABEL_VALUE_QUICK_MENU_DESC,
   MENU_ENUM_LABEL_VALUE_SHADERS_DESC,
   MENU_ENUM_LABEL_VALUE_SHADER_PRESETS_DESC,
