...
enum msg_hash_enums
{
   ...
   MENU_LABEL(QUICK_MENU_START_AUX_STREAMING),
   MENU_LABEL(QUICK_MENU_STOP_AUX_STREAMING),
   ...
   MENU_ENUM_SUBLABEL_DSU_CLIENT_SETTINGS,
   MENU_ENUM_LABEL_DSU_CLIENT_PLAYER_SETTINGS,
   MENU_ENUM_SUBLABEL_DSU_CLIENT_PLAYER_SETTINGS,
   MENU_ENUM_LABEL_DSU_CLIENT_REMOTE_SETTINGS,
   MENU_ENUM_SUBLABEL_DSU_CLIENT_REMOTE_SETTINGS,
   ...
   MENU_LABEL(NETWORK_DSU_PLAYER_ADDON),
   MENU_LABEL(NETWORK_DSU_PLAYER_ACCEL),
   MENU_LABEL(NETWORK_DSU_PLAYER_GYRO),
   MENU_LABEL(NETWORK_DSU_PLAYER_TOUCH),
   MENU_LABEL(NETWORK_DSU_PLAYER_MOUSE),
   MENU_LABEL(NETWORK_DSU_PLAYER_GAMEPAD),

   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_ADDON,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_ADDON = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_ADDON + MAX_USERS,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_ACCEL,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_ACCEL = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_ACCEL + MAX_USERS,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_GYRO,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_GYRO = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_GYRO + MAX_USERS,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_TOUCH,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_TOUCH = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_TOUCH + MAX_USERS,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_MOUSE,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_MOUSE = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_MOUSE + MAX_USERS,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_GAMEPAD,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_GAMEPAD = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_GAMEPAD + MAX_USERS,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_SERVER_ADDRESS,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_SERVER_ADDRESS = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_SERVER_ADDRESS + MAX_USERS,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_SERVER_PORT,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_SERVER_PORT = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_SERVER_PORT + MAX_USERS,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_KEYBOARD,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_KEYBOARD = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_KEYBOARD + MAX_USERS,
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_SERVER_ADDRESS,
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_SERVER_PORT,
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_KEYBOARD,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_ALLOW_STREAM_CONTROL,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_ALLOW_STREAM_CONTROL = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_ALLOW_STREAM_CONTROL + MAX_USERS,
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_ALLOW_STREAM_CONTROL,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_ALLOW_REMOTE_COMMANDS,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_ALLOW_REMOTE_COMMANDS = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_ALLOW_REMOTE_COMMANDS + MAX_USERS,
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_ALLOW_REMOTE_COMMANDS,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_BROADCAST_STATE,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_BROADCAST_STATE = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_BROADCAST_STATE + MAX_USERS,
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_BROADCAST_STATE,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_ALLOW_AUX_STREAMING,
   MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_LAST_ALLOW_AUX_STREAMING = MENU_ENUM_LABEL_NETWORK_DSU_PLAYER_1_ALLOW_AUX_STREAMING + MAX_USERS,
   MENU_ENUM_LABEL_VALUE_NETWORK_DSU_PLAYER_ALLOW_AUX_STREAMING,
   MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_1_MODE,
   MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_LAST_MODE = MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_1_MODE + MAX_USERS,
   MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_1_QUALITY,
   MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_LAST_QUALITY = MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_1_QUALITY + MAX_USERS,
   MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_1_TITLE,
   MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_LAST_TITLE = MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_1_TITLE + MAX_USERS,
   MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_1_CONFIG,
   MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_LAST_CONFIG = MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_1_CONFIG + MAX_USERS,
   MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_1_URL,
   MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_LAST_URL = MENU_ENUM_LABEL_NETWORK_AUX_SCREEN_1_URL + MAX_USERS,
   MENU_ENUM_LABEL_VALUE_NETWORK_AUX_SCREEN_MODE,
   MENU_ENUM_LABEL_VALUE_NETWORK_AUX_SCREEN_QUALITY,
   MENU_ENUM_LABEL_VALUE_NETWORK_AUX_SCREEN_TITLE,
   MENU_ENUM_LABEL_VALUE_NETWORK_AUX_SCREEN_CONFIG,
   MENU_ENUM_LABEL_VALUE_NETWORK_AUX_SCREEN_URL,
